...
export default function Login() {
  return (
    <>
      <div class="flex justify-center items-center bg-gray-100 font-[sans-serif] text-[#333] h-full md:min-h-screen p-4">
      <div class="grid justify-center max-w-md mx-auto">
        <div>
          <img src="https://readymadeui.com/login-image.webp" class="w-full object-cover" alt="login-image" />
        </div>
        <form class="bg-white rounded-2xl p-6 -mt-24 relative z-10 shadow-[0_2px_16px_-3px_rgba(6,81,237,0.3)]">
          ...
          <div class="mt-10">
            <button type="button" class="w-full py-2.5 px-4 text-sm font-semibold rounded-full text-white bg-blue-600 hover:bg-blue-700 focus:outline-none">
              Sign in
            </button>
            <p class="text-sm text-center mt-6">Don't have an account <Link to='./register' class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</Link></p>
          </div>
